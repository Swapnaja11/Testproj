...
public class LeadFormCCPPostToLandingPageTest {
	...
	public LeadFormCCPPostToLandingPageTest(SharedDriver driver) {
		this.driver = driver;
	}
	@Before
	public void setUp(){
	...
	public void i_have_logged_in_to_kwanzoo_for_Post_to_Landing_Page() throws Throwable {
	/*	login.onKwanzooSite();
	...
	public void i_go_to_Template_create_Page_for_Post_to_Landing_Page() throws Throwable {
	...
	public void i_create_a_Leadform_for_Post_to_Landing_Page() throws Throwable {
		leadformccpinstance.createLeadfomCCP();
		leadformccpinstance.post_To_Landing_Page();
	}

	@Then("^I save Leadform Widget for Post to Landing Page$")
	public void i_save_Leadform_Widget_for_Post_to_Landing_Page() throws Throwable {
		campaignFunctions.saveSettings();
		campaignFunctions.runcampaign();
	
	}

	@Then("^I go to Run Campaign Page and Activate the Leadform for Post to Landing Page$")
	public void i_go_to_Run_Campaign_Page_and_Activate_the_Leadform_for_Post_to_Landing_Page() throws Throwable {
